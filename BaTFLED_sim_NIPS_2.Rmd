...
if(.Platform$OS.type == "windows") {pkgTest('doParallel')} else pkgTest('doMC')
...
args <- list('decomp=Tucker',             # Should be either CP or Tucker factorization
             ...
             'true.0D=1',                 # Constant term
             'true.1D.m1=4',              # True 1D interactions
             'true.1D.m2=4',
             'true.1D.m3=4',
             'core.spar=0',               # Amount of sparsity in the core [0-1], 1=no sparsity
...
```{r compare core slices, results='hide', fig.align='center', fig.height=6}
par(mfrow=c(2,4))
if(model.params$decomp=='Tucker') {
